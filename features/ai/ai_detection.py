...
Your task:
- Estimate the likelihood that the given text was generated by an AI language model.
- Use linguistic and statistical patterns only.
- Do NOT make absolute claims.
- Do NOT accuse the user.
- Do NOT mention specific AI models.
...
JSON FORMAT:
{
  ...
  "explanation": "<2-3 short neutral sentences>",
  "ai_segments": "<brief description of where AI-like patterns appear>"
}
